...
@interface ZLEvent_ReportView ()<YYTextViewDelegate>
@property (nonatomic, strong) NSMutableArray *sourceArray;
@end

@implementation ZLEvent_ReportView
...
- (void)loadData{
    ...
    NSArray *array = (NSArray *)[[[ZLDBStoreManager shareDbStoreManager]createDB] getObjectById:DBEventObject fromTable:DBUserTable];
