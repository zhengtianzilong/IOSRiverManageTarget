...
@interface ZLGaodeReportEventVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ZLGaodeReportEventVC
...
- (void)getuserListData{
    ...
    ZLGetUserListByIncidentService *service = [[ZLGetUserListByIncidentService alloc]initWithriverCode:_userRiverModel.riverCode];
...
- (UITableView *)mainTableView{
    if (!_mainTableView) {
        ...
        ZLNewReportBottomView *bottomView = [[ZLNewReportBottomView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(mediaView.frame) + 50, Main_Screen_Width, 50 * kScreenHeightRatio) withTitles:@[@"立即上报",@"取消上报"]];
