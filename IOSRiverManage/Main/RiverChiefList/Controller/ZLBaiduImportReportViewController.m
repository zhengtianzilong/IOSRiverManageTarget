//
//  ZLBaiduImportReportViewController.m
//  IOSRiverManage
//
...
@interface ZLBaiduImportReportViewController ()
@property (nonatomic, strong) UIScrollView *mainScrollview;
@property (nonatomic ,assign) CGFloat height;

@property (nonatomic, strong) ZLBaiduReportView *reportView;
// 照片数组
@property (nonatomic, strong) NSArray *imageArray;
@end

@implementation ZLBaiduImportReportViewController
...
- (void)viewDidLoad {
    ...
    //    self.mainScrollview.contentSize = CGSizeMake(0, App_Frame_Height * 2);
    ...
    [self.mainScrollview mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(App_Frame_Width);
        make.height.mas_equalTo(App_Frame_Height * 0.8 - AdaptedHeight(115) - AdaptedHeight(170));
    }];
    ...
    if (_isHaveInfoView) {
        ...
        infoView.titleLabel.text = _demandModel.rivers_name;
        infoView.startAddressLabel.text = _demandModel.start_point_desc;
        infoView.endAddressLabel.text = _demandModel.end_point_desc;
        ...
        _reportView = [[ZLBaiduReportView alloc]initWithFrame:CGRectZero riverId:_demandModel.riverId];
        ...
        [_reportView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.height.mas_equalTo(AdaptedHeight(600));
...
- (void)startReportClick
{
    ...
    ZLRiverChiefAddEventService *service = [[ZLRiverChiefAddEventService alloc]initWitheventName:title eventContent:note positionDesc:address uuid:_uuid type:_type lgt:lgt lat:lat riverid:_demandModel.riverId liable_id:_reportView.liable_id uid:_uid dataImgBase:imageString];
