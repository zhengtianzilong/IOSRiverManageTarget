...
@interface ZLBaiduReportView ()<UITextViewDelegate>
@property (nonatomic, strong) NSMutableArray *sourceArray;
@property (nonatomic, assign) CGRect kbRect;
@end

@implementation ZLBaiduReportView
...
- (void)setUpUI{
    ...
    [_noteTextView addPlaceHolder:@"请输入反馈内容(140字以内)"];
    
//    UIToolbar * topView = [[UIToolbar alloc]initWithFrame:CGRectMake(0, 0, 320, 30)];
//    [topView setBarStyle:UIBarStyleDefault];
//    
//    UIBarButtonItem * helloButton = [[UIBarButtonItem alloc]initWithTitle:@"反馈信息:" style:UIBarButtonItemStylePlain target:self action:nil];
//    
...
//    ZLLoginModel *loginModel = [NSKeyedUnarchiver unarchiveObjectWithData:data];
    ...
    ZLEventObjectService *eventObjectService = [[ZLEventObjectService alloc]initWithuid:loginModel.userId riverId:tempRiverId];
...
//                [_nameArray addObject:_sourceArray[[i intValue]]];
            ...
            weakSelf.reportObjectView.eventTextfiled.text = [_nameArray componentsJoinedByString:@" "];
