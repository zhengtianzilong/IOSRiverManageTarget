...
- (void)reportClick{
    ...
    ZLAlertSelectionView *alert = [[ZLAlertSelectionView alloc]initWithFrame:CGRectZero sourceArray:sourceArray withTitle:@"下发对象" sureTitle:@"下发" singleSelection:NO];
    [alert show];
...
- (ZLMyAdviseBottomView *)advisebottomView{
    ...
    if (!_advisebottomView) {
        ...
        _advisebottomView = [[ZLMyAdviseBottomView alloc]init];
        
        [_advisebottomView.startButton setTitle:@"继续下发" forState:(UIControlStateNormal)];
        [_advisebottomView.endButton setTitle:@"任务反馈" forState:(UIControlStateNormal)];
...
- (NSMutableAttributedString *)setTitle{
    ...
    NSMutableAttributedString *title = [[NSMutableAttributedString alloc]initWithString:@"我的意见" attributes:dic];
