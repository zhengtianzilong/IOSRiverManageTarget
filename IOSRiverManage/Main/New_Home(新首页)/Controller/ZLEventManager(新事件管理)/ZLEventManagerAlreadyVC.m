...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZLEventManageTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ZLEventManageTableViewCell" forIndexPath:indexPath];
...
- (UITableView *)mainTableView{
    if (!_mainTableView) {
        ...
        [_mainTableView registerClass:[ZLEventManageTableViewCell class] forCellReuseIdentifier:@"ZLEventManageTableViewCell"];
