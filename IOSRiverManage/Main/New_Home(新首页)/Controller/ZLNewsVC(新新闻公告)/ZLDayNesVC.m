...
@interface ZLDayNesVC ()<UITableViewDelegate, UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZLDayNewsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ZLDayNewsTableViewCell" forIndexPath:indexPath];
...
- (UITableView *)mainTableView{
    if (!_mainTableView) {
        ...
        [_mainTableView registerClass:[ZLDayNewsTableViewCell class] forCellReuseIdentifier:@"ZLDayNewsTableViewCell"];
