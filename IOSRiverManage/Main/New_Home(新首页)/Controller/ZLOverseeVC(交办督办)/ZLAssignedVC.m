...
@interface ZLAssignedVC ()<UITableViewDelegate, UITableViewDataSource>
...
- (void)setTabViewHeadView{
    ...
    self.queryView = [[ZLQueryAssignedView alloc] init];
...
//        time = [time substringToIndex:time.length - 3];
    ...
    self.departPeople = self.queryView.selectInfoView.people.infoTextField.text;
    //    [self listData];
