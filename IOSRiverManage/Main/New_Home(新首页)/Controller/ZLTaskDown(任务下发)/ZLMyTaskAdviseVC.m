...
@implementation ZLMyTaskAdviseVC
...
- (void)reportClick{
    ...
    dispatch_group_notify(group, dispatch_get_main_queue(), ^{
        ...
        ZLFeedbackTaskService *service = [[ZLFeedbackTaskService alloc]initWithimgList:self.imageNameArray taskId:self.taskDetailId feedbackContent:_eventDesc];
...
- (UITableView *)mainTableView{
    if (!_mainTableView) {
        ...
        ZLMyAdviseBottomView *bottomView = [[ZLMyAdviseBottomView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(mediaView.frame) + 50, Main_Screen_Width, 50 * kScreenHeightRatio) withTitles:@[@"任务反馈",@"取消反馈"]];
