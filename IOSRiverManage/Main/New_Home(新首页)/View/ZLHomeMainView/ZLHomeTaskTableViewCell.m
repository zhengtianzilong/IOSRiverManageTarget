...
@implementation ZLHomeTaskTableViewCell
...
- (void)setUpUI{
    ...
    [_initiatorName mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(_initiatorLabel);
    }];
    ...
    [_content mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(self.contentView.mas_right).offset(-5);
        make.bottom.equalTo(_imageV.mas_bottom).offset(15);
    }];
    ...
    [_lineViewBottom mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.contentView);
        make.right.equalTo(self.contentView.mas_right);
        make.top.equalTo(_imageV.mas_bottom).offset(15);
        make.height.mas_equalTo(1);
    }];
