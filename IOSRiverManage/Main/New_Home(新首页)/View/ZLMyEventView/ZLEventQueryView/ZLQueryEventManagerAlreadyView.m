//
//  ZLQueryEventManagerAlreadyView.m
//  IOSRiverManage
//
...
@implementation ZLQueryEventManagerAlreadyView
...
- (ZLEventManagerAlreadySelectInfoView *)selectInfoView{
    if (!_selectInfoView) {
        _selectInfoView = [[ZLEventManagerAlreadySelectInfoView alloc]init];
    }
