...
@implementation ZLZLQueryEventDownView
...
- (ZLEventDownManagerSelectInfoView *)selectInfoView{
    if (!_selectInfoView) {
        _selectInfoView = [[ZLEventDownManagerSelectInfoView alloc]init];
    }
