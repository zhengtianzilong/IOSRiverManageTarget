//
//  ZLEventManagerCheckSelectInfoView.h
//  IOSRiverManage
//
...
@interface ZLEventManagerCheckSelectInfoView : UIView
@property (nonatomic, strong) ZLLabelAndTextFieldView *eventName;
@property (nonatomic, strong) ZLLabelAndTextFieldView *people;

@property (nonatomic, strong) ZLLabelAndTextFieldView *executorPeople;

@property (nonatomic, strong) ZLLabelAndTextFieldWithImageV *state;
