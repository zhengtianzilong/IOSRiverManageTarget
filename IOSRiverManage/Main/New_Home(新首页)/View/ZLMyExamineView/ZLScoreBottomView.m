...
@implementation ZLScoreBottomView
...
- (UIButton *)saveButton{
    ...
    if (!_saveButton) {
        ...
        [_saveButton setTitleColor:HEXCOLOR(CNAVGATIONBAR_COLOR) forState:(UIControlStateNormal)];
        _saveButton.backgroundColor = [UIColor whiteColor];
        _saveButton.layer.borderColor = HEXCOLOR(CNAVGATIONBAR_COLOR).CGColor;
        _saveButton.layer.cornerRadius = 5;
        _saveButton.clipsToBounds = YES;
