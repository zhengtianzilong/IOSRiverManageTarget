...
@implementation ZLQueryAssignedView
...
- (ZLAssignedSelectInfoView *)selectInfoView{
    if (!_selectInfoView) {
        _selectInfoView = [[ZLAssignedSelectInfoView alloc]init];
...
//    self.selectInfoView.assignedTimeView.endTimeView.selectTimeLabel.text = currentDateStr;
//
...
//    self.selectInfoView.assignedTimeView.startTimeView.selectTimeLabel.text = beforDate;
//}
