...
- (void)setupSubviews
{
    ...
    [self.contentView addSubview:self.tipsImageV];
    ...
    self.layer.borderColor = HEXCOLOR(CVIEW_GRAY_COLOR).CGColor;
...
- (UIImageView *)tipsImageV{
    
    if (!_tipsImageV) {
        _tipsImageV = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"score_mark"]];
