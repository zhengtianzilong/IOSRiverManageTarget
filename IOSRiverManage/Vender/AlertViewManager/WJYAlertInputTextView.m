...
//  SmartCities
//
//  Created by caizilong on 16/8/4.
...
-(void)layoutViewPage
{
    ...
    if (!self.contentTextView) {
        ...
        self.contentTextView.font = SYSTEMFONT(14);
...
//        [self.rightButton setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
        [self.rightButton setTitleColor:[UIColor colorWithRed:0 green:0.478431 blue:1.0 alpha:1.0] forState:UIControlStateNormal];
