//
//  WJYAlertView
//  SmartCities 自定义UIAlertView样式（由JCAlertView修改）
//
//  Created by caizilong on 16/8/3.
...
- (void)setButton:(UIButton *)btn BackgroundWithButonType:(WJYAlertViewButtonType)buttonType{
    ...
    switch (buttonType) {
        case WJYAlertViewButtonTypeDefault:
            normalImage = [self imageFromColorWithColor:HEXCOLOR(KNavBarBG_color_blue)];
            highImage = [self imageFromColorWithColor:HEXCOLOR(KNavBarBG_color_blue)];
